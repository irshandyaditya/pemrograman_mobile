...
class _BestDealsWidgetState extends State<BestDealsWidget> {
  ...
  final List<String> descriptions = [
    'Cashback 50% hanya dengan LinkAja',
    'Beli makanan dapat Cashback 50%',
    'Praktis & Aman dengan LinkAja'
  ];

  final List<String> additionalTexts = [
    'LinkAja menyediakan cashback point sebesar 50%',
    'Dapatkan cashback 50% di LinkAja ',
    'Dapatkan cashback sebeser Rp 20.000 di LinkAja'
  ];
