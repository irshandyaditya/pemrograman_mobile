...
import '../widgets/historyCardWidget.dart';
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            Container(
              color: Color.fromARGB(1000, 232, 232, 242),
              child: Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Image.asset(
                      'assets/pending-completed.jpg', // Ensure the asset path is correct
                      height: 150,
                    ),
                    SizedBox(height: 16),
                    Text(
              ...
              child: Padding(
                ...
                child: ListView(
                  children: [
                    TransactionCard(
                      title: 'Pay Merchant',
                      date: '27 Oct 2024 07:30',
                      amount: 'Rp 20.000',
                      status: 'Success',
                      description: 'Alfamidi Purchase',
                    ),
                    TransactionCard(
                      title: 'Pay Merchant',
                      date: '27 Oct 2024 02:30',
                      amount: 'Rp 50.000',
                      status: 'Fail',
